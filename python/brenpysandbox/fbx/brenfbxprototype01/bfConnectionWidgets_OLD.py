...
#         self.connect_widgets()
    ...
    def connect_widgets(self):
        ...
        #
        self.view.setModel(self._name_filter_model)
    ...
    def create_view(self):
        self.view = Qt.QtWidgets.QTableView()
...
#         self._name_filter_model.setSourceModel(scene_model)
        ...
        self._connection_model.set_scene_model(scene_model)
...
class SrcOPWidget(BfConnectionWidgetBase):

    CONNECTION_MODEL = bfConnectionModels.BFbxSrcOPModel

    TYPE_LABEL_TEXT = "Src Objects"

    def __init__(self, parent=None):
        super(SrcOPWidget, self).__init__(parent=parent)

    def set_property(self, object_id, property_id):
        self._connection_model.set_property(object_id, property_id)


class SrcPPWidget(BfConnectionWidgetBase):

    CONNECTION_MODEL = bfConnectionModels.BFbxSrcPPModel

    TYPE_LABEL_TEXT = "Src Properties"

    SELECTION_DIALOG = BFbxPropertySelectionDialog

    def __init__(self, parent=None):
        super(SrcPPWidget, self).__init__(parent=parent)
...
class Test1(Qt.QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        self.sop_widget = SrcOPWidget()
        self.sop_widget.set_scene_model(self.scene_model)
